...
const InformationCollection = () => {
  ...
  return (
    <div  className={classes.pageSection} id="informationCollection">
      <Title className={classes.pageTitle}>Information we collect</Title>
      <Text className={classes.paragraph}>We collect the following information about you:</Text>
      <Text fw={700} fz="md">Your Contact Information</Text>
      ...
      <Text fw={700} fz="md" className={classes.subHeading}>Data You Provide to Us</Text>
      <Text className={classes.paragraph}>
      ...
      <Text fw={700} fz="md" className={classes.subHeading}>Data from surveys and user feedback</Text>
      <Text className={classes.paragraph}>
      ...
      <Text fw={700} fz="md" className={classes.subHeading}>Usage and Log Data</Text>
      <Text className={classes.paragraph}>
      ...
      <Text fw={700} fz="md" className={classes.subHeading}>Device And Connection Information</Text>
      <Text className={classes.paragraph}>
      ...
      <Text fw={700} fz="md" className={classes.subHeading}>Third Party Information</Text>
      <Text className={classes.paragraph}>
      ...
      <Text fw={700} fz="md" className={classes.subHeading}>Cookie information</Text>
      <Text className={classes.paragraph}>
