  ...
  return (
    <div id="privacyScope" ref={innerRef} className={classes.pageSection}>
      ...
      <Text className={classes.paragraph}>
        ...
        activities we engage in (collectively, &quot;Activities&quot;). We
        outline the data we gather about you in connection with our sites and
        activities in this privacy statement. We then go over how we use and
        disclose this information, as well as how you can exercise any
        applicable rights.
      </Text>
      <Text className={classes.paragraph}>
        ...
        the Zuri Chat platform (&quot;Third-Party Services&quot;). The
        processing of data, including messages, files, and other content
        supplied through Services accounts (collectively, &quot;Customer
        Data&quot;), is governed separately by a separate agreement (the
        &quot;Customer Agreement&quot;), which also controls delivery, access,
        and use of the Services. The instance of the Services (its
        &quot;Workspace&quot;) and any related Customer Data are under the
        control of the business (such as your employer or another company or
        person) that entered into the Customer Agreement (the
        &quot;Customer&quot;). Please get in touch with the to ask any queries
        you may have concerning specific Workspace settings and privacy
        policies.
      </Text>
      <Text className={classes.paragraph}>
